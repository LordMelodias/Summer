...
SECRET_KEY = 'django-insecure-3-py2_ehp)hz_dbi_#c%184u95atq3auk&^)5uxluljts(4o)7'
...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': 'youtube',  # Name of your MongoDB database
...
# Define the URL prefix for media files (e.g. "/media/")
MEDIA_URL = '/media/'
